        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttachCv = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    IsJobless = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Photo = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    CanManageAccount = table.Column<bool>(type: "bit", nullable: false),
                    CanManageJobs = table.Column<bool>(type: "bit", nullable: false),
                    CanManageChats = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserJobs_JobCategories_JobCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HiringQuantity = table.Column<int>(type: "int", nullable: false),
                    Gender = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    JobEditRequestDetails = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserJobCategories", x => new { x.UserTableId, x.JobCategoryId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserJobCategories_UserJobs_UserTableId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FavoriteJobs_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobApplications_UserJobs_UserTableId",
                        column: x => x.UserTableId,
                        principalTable: "UserJobs",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavoriteJobs_ApplicationUserId",
                table: "FavoriteJobs",
                column: "ApplicationUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobApplications_UserTableId",
                table: "JobApplications",
                column: "UserTableId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserJobs_JobCategoryId",
                table: "UserJobs",
                column: "JobCategoryId");
